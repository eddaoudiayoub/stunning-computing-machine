...
$(document)['ready'](function () {
        $('.abdelali-prot')['html']('<a href="https://thhyper.blogspot.com/" rel="dofollow" target="_blank"> تطوير و تصميم :هايبر للمعلوميات </a>');
        setInterval(function () {
                if (!$('.abdelali-prot:visible')['length']) {
                  window['location']['href'] = 'https://thhyper.blogspot.com/';
                };
            }, 3000);
    });
